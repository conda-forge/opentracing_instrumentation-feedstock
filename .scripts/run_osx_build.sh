...
validate_recipe_outputs "opentracing_instrumentation-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="opentracing_instrumentation-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi